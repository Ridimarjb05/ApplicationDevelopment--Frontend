...
export default function CustomerDetail() {
  ...
  if (error) return (
    <div style={{ textAlign: 'center', padding: '80px 20px' }}>
      ...
      <Link to="/staff/customers" style={{ color: '#2563eb', fontSize: '13px', fontWeight: 600, textDecoration: 'none' }}>← Back to Customers</Link>
    </div>
  )
  ...
  return (
    <div style={{ maxWidth: '960px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      {/* Back */}
      <Link to="/staff/customers" style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', fontSize: '13px', color: '#64748b', textDecoration: 'none', fontWeight: 500 }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e3a5f 60%, #1d4ed8 100%)', padding: '28px 28px 22px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '18px', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', flexShrink: 0 }}>
              <Link to="/staff/customers" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,0.12)', color: '#fff', fontSize: '12px', fontWeight: 600, padding: '8px 14px', borderRadius: '8px', textDecoration: 'none', border: '1px solid rgba(255,255,255,0.2)' }}>
                ← All Customers
              </Link>
            </div>
          </div>
