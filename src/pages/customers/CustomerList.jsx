  ...
  return (
    <div style={{ maxWidth: '1200px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        <Link to="/staff/customers/register" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#2563eb', color: '#fff', padding: '9px 18px', borderRadius: '9px', fontSize: '13px', fontWeight: 600, textDecoration: 'none' }}>
              ...
              {filtered.map((c, idx) => (
                <tr key={c.customerID} style={{ borderBottom: '1px solid #f1f5f9' }}
                  ...
                  <td style={{ padding: '12px 16px', textAlign: 'right' }}>
                    <Link to={`/staff/customers/${c.customerID}`} style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '12px', fontWeight: 600, color: '#2563eb', textDecoration: 'none', padding: '5px 10px', borderRadius: '6px', border: '1px solid #bfdbfe', background: '#eff6ff' }}>
                      View Profile
                    </Link>
                  </td>
                </tr>
