  ...
  return (
    <div style={{ maxWidth: '1200px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        <Link to="/staff/invoices/create" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#2563eb', color: '#fff', padding: '9px 18px', borderRadius: '9px', fontSize: '13px', fontWeight: 600, textDecoration: 'none' }}>
      ...
      <div style={{ background: '#fff', borderRadius: '12px', border: '1px solid #e8ecf0', overflow: 'hidden' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '60px 20px', color: '#94a3b8' }}>
            ...
            <Link to="/staff/invoices/create" style={{ display: 'inline-block', marginTop: '8px', fontSize: '13px', color: '#2563eb', fontWeight: 600, textDecoration: 'none' }}>Create your first invoice →</Link>
          </div>
        ) : (
          <>
